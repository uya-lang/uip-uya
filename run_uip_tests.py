...
TEST_DEPS = {
    ...
    "uip_public_api_compat_test.uya": ["ports/uip/uip_core.uya", "ports/uip/uip_base.uya"],
    "uip_fw_compat_test.uya": ["ports/uip/uip_fw_core.uya", "ports/uip/uip_base.uya", "ports/uip/uip_core.uya"],
    "uip_multi_conn_test.uya": ["ports/uip/uip_core.uya"],
    "uip_missing_features_test.uya": ["ports/uip/uip_core.uya", "ports/uip/uip_arp.uya"],
